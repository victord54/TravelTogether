...
CREATE TABLE
    NOTIFICATION(
        ...
        typeNotif ENUM('Groupe', 'Offre', 'Reponse', 'Resultat', 'ModifOffre', 'Annulation', 'AnnulationParticipation'),
        ...
        statutReponse ENUM('attente', 'accepter', 'refuser', 'annuler'),
        nbPlaceSouhaitees INT DEFAULT 0,
