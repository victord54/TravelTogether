...
function Login() {
    ...
    const getUser = async () => {
        try {
            const reponse = await axios.get("http://localhost/TravelTogether/backend/", { params : {
            ...
            if (reponse.data == null){
                ...
                localStorage.setItem('aUneVoiture', reponse.data['aUneVoiture'])
                localStorage.setItem('notificationParMail', reponse.data['notificationParMail'])
            }
            console.log("Reponse : ")
